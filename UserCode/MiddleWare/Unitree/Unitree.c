...
void my_Unitree_UART_Message_Task(void *argument)
{
    for (;;) {
        ...
        Unitree_UART_tranANDrev(&unitree_DunkMotor_t[0], 0, 1, unitree_DunkMotor_t[0].cmd.T,unitree_DunkMotor_t[0].cmd.W, unitree_DunkMotor_t[0].cmd.Pos, unitree_DunkMotor_t[0].cmd.K_P, unitree_DunkMotor_t[0].cmd.K_W);
        osDelay(2);
        Unitree_UART_tranANDrev(&unitree_DunkMotor_t[1], 1, 1, unitree_DunkMotor_t[1].cmd.T,unitree_DunkMotor_t[1].cmd.W, unitree_DunkMotor_t[1].cmd.Pos, unitree_DunkMotor_t[1].cmd.K_P, unitree_DunkMotor_t[1].cmd.K_W);
        osDelay(2);
        Unitree_UART_tranANDrev(&unitree_DunkMotor_t[2], 2, 1, unitree_DunkMotor_t[2].cmd.T,unitree_DunkMotor_t[2].cmd.W, unitree_DunkMotor_t[2].cmd.Pos, unitree_DunkMotor_t[2].cmd.K_P, unitree_DunkMotor_t[2].cmd.K_W);
        osDelay(2);
        Unitree_UART_tranANDrev(&unitree_DunkMotor_t[3], 3, 1, unitree_DunkMotor_t[3].cmd.T,unitree_DunkMotor_t[3].cmd.W, unitree_DunkMotor_t[3].cmd.Pos, unitree_DunkMotor_t[3].cmd.K_P, unitree_DunkMotor_t[3].cmd.K_W);
        osDelay(2); 
