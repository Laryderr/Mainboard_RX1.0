...
void my_Unitree_UART_Message_Task(void *argument)
{
    for (;;) {
        ...
        osDelay(2);
        Unitree_UART_tranANDrev(&unitree_DunkMotor_t[1], 1, 1, 0, 0, unitree_DunkMotor_posdes[1], unitree_DunkMotor_kp[1], unitree_DunkMotor_kw[1]);
        osDelay(2);
        Unitree_UART_tranANDrev(&unitree_DunkMotor_t[2], 2, 1, 0, 0, unitree_DunkMotor_posdes[2], unitree_DunkMotor_kp[2], unitree_DunkMotor_kw[2]);
        osDelay(2); 
