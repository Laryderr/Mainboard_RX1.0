...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOH, POWER1_Pin|POWER2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, AS69_MD1_Pin|AS69_MD0_Pin, GPIO_PIN_SET);
  ...
  GPIO_InitStruct.Pin = POWER1_Pin|POWER2_Pin|POWER3_Pin;
  ...
  GPIO_InitStruct.Pin = AS69_AUX_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(AS69_AUX_GPIO_Port, &GPIO_InitStruct);
